package com.raphydaphy.thaumcraft.client;
...
public interface IHasModel {
	...
	public static void sMRL(String statePath, Item k, int meta, String variant) {
		ModelLoader.setCustomModelResourceLocation(k, meta, new ModelResourceLocation(Thaumcraft.MODID + ":" + statePath, variant));
	}
