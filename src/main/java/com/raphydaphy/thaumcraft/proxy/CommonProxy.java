...
public class CommonProxy
{
	...
	public static void registerItems(RegistryEvent.Register<Item> event)
	{
		...
		registry.register(new ItemBase("shard", 6));
		registry.register(new ItemScribingTools("scribing_tools"));
		registry.register(new ItemBase("knowledge_fragment"));
		registry.register(new ItemFoci("focus_fire"));
		
		// Trees
		registry.register(
				new ItemBlock(ModBlocks.log_greatwood).setRegistryName(ModBlocks.log_greatwood.getRegistryName()));
		registry.register(
				new ItemBlock(ModBlocks.log_silverwood).setRegistryName(ModBlocks.log_silverwood.getRegistryName()));
		registry.register(new ItemBlock(ModBlocks.leaves_greatwood)
				.setRegistryName(ModBlocks.leaves_greatwood.getRegistryName()));
		registry.register(new ItemBlock(ModBlocks.leaves_silverwood)
				.setRegistryName(ModBlocks.leaves_silverwood.getRegistryName()));
		registry.register(new ItemBlock(ModBlocks.planks_greatwood)
				.setRegistryName(ModBlocks.planks_greatwood.getRegistryName()));
		registry.register(new ItemBlock(ModBlocks.planks_silverwood)
				.setRegistryName(ModBlocks.planks_silverwood.getRegistryName()));
		...
		// Ores
		registry.register(
				new ItemBlock(ModBlocks.ore_infused).setRegistryName(ModBlocks.ore_infused.getRegistryName()));

		// Tables
		registry.register(new ItemBlock(ModBlocks.table).setRegistryName(ModBlocks.table.getRegistryName()));
		registry.register(new ItemBlock(ModBlocks.arcane_worktable)
				.setRegistryName(ModBlocks.arcane_worktable.getRegistryName()));
	}
}
