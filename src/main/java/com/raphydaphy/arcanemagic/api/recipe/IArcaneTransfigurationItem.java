...
public interface IArcaneTransfigurationItem
{
	...
	/**
	 * Use this to decide if you actually can craft this recipe. If you return
	 * false, the recipe will not match. Return true, and the recipe will
	 * continue to its own check.
	 * 
	 * @param recipe
	 *            The current recipe
	 * @param player
	 ...
	 *            The wand itemstack
	 * @param stacks
	 *            The current list of stacks in the elemental crafter
	 * @param world
	 *            The world
	...
	/**
	 * This method must return false if you do not have the IAnimaStorage
	 * capability.
	 * 
