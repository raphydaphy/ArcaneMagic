...
public class AnimaStack
{
	...
	/*
	 * Saves all these anima stacks to a subcompound in the passed in tag.  Duplicates will use the last passed stack.  This method overrides all existing data, save wisely.
	 */
