		...
		if (stack.getItem() instanceof ItemEssenceChannelingRod)
		{
			...
			if (foundRecipe != null)
			{
				if (!world.isRemote)
				{
					...
					/*
					 * ArcaneMagicPacketHandler.INSTANCE.sendTo( new
					 * PacketItemAnimaChanged(stack.getCapability(IAnimaStorage.
					 * CAP, null), ItemScepter.stupidGetSlot(player.inventory,
