...
public class RecipeHelper
{
	...
	public static <T extends IForgeRegistryEntry<?>> void addShaped(String group, T output, int width, int height,
			Object... input)
	{
		...
		for (IRecipe rec : ForgeRegistries.RECIPES)
		{
			...
			} else
			{
				...
				ForgeRegistries.RECIPES.register(
						new ShapelessRecipes(rec.getGroup(), rec.getRecipeOutput(), list).setRegistryName(regname));
			}
		}
	}
