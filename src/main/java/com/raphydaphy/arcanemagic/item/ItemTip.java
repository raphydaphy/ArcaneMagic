...
public class ItemTip extends ItemBase implements ScepterPartItem
{
	...
	{
		IRON("iron"), GOLD("gold"), THAUMIUM("thaumium"),;
		...
		Type(String name)
		{
			this(name, ArcaneMagic.MODID + ".tip." + name, new ResourceLocation(ArcaneMagic.MODID, name),
					new ResourceLocation(ArcaneMagic.MODID, "items/scepter/tip_" + name));
		}
