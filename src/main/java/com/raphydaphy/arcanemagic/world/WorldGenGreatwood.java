package com.raphydaphy.arcanemagic.world;
...
public class WorldGenGreatwood extends WorldGenHugeTrees implements IWorldGenerator
{
	...
	{
		this.generate(world, random, world.getTopSolidOrLiquidBlock(
				new BlockPos(chunkX * 16 + random.nextInt(16), 60, chunkZ * 16 + random.nextInt(16))));
	}
}